...
The hero illustration is a model-generated still-life of three flashcard answer slips, halftone dots, registration marks, and a small brass interval dial. It contains no required text. Source candidates live in `assets/src/`; optimized, filename-versioned WebP and social crops live in `public/assets/`.
