...
function termsPage(): string { return shell(`<article class="legal"><p class="eyebrow">Terms / August 29, 2026</p><h1 tabindex="-1">Use Recall Anchor for personal study</h1><p>Recall Anchor helps you study. It does not measure learning ability or guarantee recall.</p><h2>Free and paid use</h2><p>The free plan holds 30 cards. The Recall Anchor Desk license costs $19 once and adds unlimited cards plus review trends.</p><h2>Purchases</h2><p>The Desk purchase opens Sociobot’s hosted checkout. Sociobot/Dodo is the merchant of record and handles refunds for Desk purchases. A license must be active for paid features to remain available.</p><h2>Your responsibility</h2><p>Keep an encrypted backup and its passphrase. Browser storage can be cleared by your device or browser.</p><h2>Warranty</h2><p>The software is provided as is under the MIT License. Use it only where local law allows.</p></article>`); }
